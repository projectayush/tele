...
// exports.updateDeptTicket = async(req , res)=>{
//   const ticketsData = new TicketModel(req.body);
//   try{
//       const upDeptTicket = await TicketModel.updateDeptTicket(req.params.id , ticketsData);
//       res.status(200).json({upDeptTicket});
//   }catch(error){
//       res.status(400).json({message: `${error}`});
//   }
// };
