...
var Ticket = function (ticket) {
	...
	// // this.department_name = ticket.department_name;
	// this.category_name = ticket.category_name;
	// this.subcategory_name = ticket.subcategory_name;
	// this.title_name = ticket.title_name;
...
Ticket.createTicket = (ticketData, result) => {
	...
	// 	return new Promise((resolve, reject) => {
	// 		dbConn.query("UPDATE tickets SET user_id=? , created_by=? ,ticket_id=? , category_id=?,subcategory_id=? , title_id=?,description=? , department_id=?,	status=? , department_name ,	category_name , subcategory_name,title_name , username  WHERE id=?"
						 
			
	// 		 ,[
	// 			ticketData.user_id , ticketData.created_by,
	// 			ticketData.ticket_id , ticketData.category_id,
	// 			ticketData.title_id , ticketData.subcategory_id,
	// 			ticketData.description , ticketData.department_id,
	// 			ticketData.status , ticketData.department_name , 
	// 			ticketData.category_name , ticketData.subcategory_name,
	// 			ticketData.title_name , ticketData.username ,id
	// 		], (err, res) => {
	// 			if (err)
	// 				return reject(err);
	// 			resolve(res);
	...
	Ticket.updateTicket = (id, ticketData, result) => {
		...
		user_id=?,
		 ...
		 WHERE id=?`, [ticketData.user_id,
			 ...
			 ticketData.ticket_id, ticketData.category_id,
			  ticketData.subcategory_id, ticketData.title_id,
				 ticketData.description, ticketData.department_id, ticketData.status, id], (err, res) => {
						if (err)
								return reject(err);
						resolve(res);
				});
