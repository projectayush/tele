        ...
        <ModalBody>
          <form  >
            <div className="row   ">
              ...
              <div >
                <input className='text-left fs-5' type='text' name='text' placeholder='Enter Title' required style={{ width: '40%' }, { height: '170%' }}
                ...
                <div className="row">
                  ...
                  <div className="col-md-6 d-flex align-items-end justify-content-end  mt-1">
                    ...
                    <button type="button"
                      ...
                      style={{ width: "30%" }, { backgroundColor: 'orangered' }}>Add Category</button>
                  </div>
                </div>
                <hr />
